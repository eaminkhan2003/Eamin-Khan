...
const TECH_STACK = ["HTML", "CSS", "Javascript", "Boostrap",];
const SOCIAL_LINKS = [
  { icon: Github, link: "#" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/eaminshuvoo/" },
  { icon: Instagram, link: "https://www.instagram.com/eaminshuvoo" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                 Md. Eamin Khan is a passionate Web Developer, creating modern, responsive, and user-friendly websites to enhance online presence and business growth.
                </p>
